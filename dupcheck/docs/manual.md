...
2024-01-05 10:30:00,C:\rpa\orders,C:\rpa\orders\history,受注_20240103.txt,重複
2024-01-06 09:15:00,C:\rpa\orders,C:\rpa\orders\history,受注_20240106.txt,重複
```
...
```cmd
dupcheck.exe -target C:\orders -history C:\orders\history -dupfile -log
```
...
[コマンド実行]
  ...
  引数: -target C:\orders -dupfile C:\logs\detail.log -log C:\logs\result.csv
